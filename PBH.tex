...
\newcommand{\SPMaryAdvent}{BCP 562}%\pageref{SPMaryInAdvent}} 
\newcommand{\SPMaryChristmas}{BCP 562}%\pageref{SPMaryPostChristmas}}
\newcommand{\SPMaryEaster}{BCP 562}%\pageref{SPMaryInEaster}}
\newcommand{\SPSaints}{BCP 563}%\pageref{SPSaints}}
\newcommand{\SPAgainst}{BCP 563}%\pageref{SPAgainst}}
\newcommand{\SPChiefBishop}{BCP 564}%\pageref{SPChiefBishop}}
\newcommand{\SPHolyGhost}{BCP 564}%\pageref{SPHolyGhost}}
\newcommand{\SPLiving}{BCP 565}%\pageref{SPLivingDeparted}}
\newcommand{\Lammas}{BCP 496}
...
%For Rubric Colour:
%\definecolor{RubricRed}{RGB}{145, 4, 10}
%CMYK for printing:
\definecolor{RubricRed}{cmyk}{0, 1, 1, 0.25}
...
%\include{pages/Propers/Seasonal.tex}
%Hymn Index
%\cleardoublepage
