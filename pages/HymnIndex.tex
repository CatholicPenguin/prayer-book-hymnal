...
\par\noindent
\textit{Aeterna Christi munera} (The eternal gifts of Christ the King) \dotfill p. \pageref{ApostlesInvitatory}
\par\noindent
\textit{Aeterna Christi munera et Martyrum} (The Martyrs' triumphs let us sing) \dotfill p. \pageref{MartyrsInvitatory}
\par\noindent
\textit{Aeterna Imago Altissime} (Image Eterne of God Most High) \dotfill p. \pageref{ChristTheKingInvitatory}
\par\noindent
...
\par\noindent
All glorious King of Martyrs thou (\textit{Rex gloriose Martyrum}) \dotfill p. \pageref{MartyrsEvensongEaster} (Martyrs Evensong in Easter), p. \pageref{MartyrsMattins} (Martyrs Mattins)
\par\noindent
...
\par\noindent
\textit{Angularis fundamentum} (Christ is Made the Sure Foundation) \dotfill p. \pageref{DedicationMattins}
\par\noindent
...
\par\noindent
\textit{Ave maris stella} (Star of ocean fairest) \dotfill p. \pageref{BVMEvensong}
\par\noindent
...
\par\noindent
Blessed City, Heav'nly Salem (\textit{Urbs Jerusalem beata}) \dotfill p. \pageref{DedicationEvensong}
\par\noindent
...
\par\noindent
\textit{Caelitum, Joseph, decus} (Joseph, the praise and glory) \dotfill p. \pageref{JosephInvitatory} (Joseph Invitatory)
\par\noindent
\textit{Caelo Redemptor Praetulit} (The world's Redeemer from the earth) \dotfill p. \pageref{MotherhoodInvitatory}
\par\noindent
Christ is Made the Sure Foundation (\textit{Angularis fundamentum}) \dotfill p. \pageref{DedicationMattins}
\par\noindent
...
\par\noindent
\textit{Claro Paschali gaudio} (In this our bright and Paschal day) \dotfill p. \pageref{ApostlesMattinsEaster}
\par\noindent
...
\par\noindent
\textit{Consors paterni} (Light of Light, O Dayspring bright) \dotfill p. \pageref{TuesdayInvitatory}
\par\noindent
...
\par\noindent
Creator of the Earth and Sky (\textit{Deus creator omnium}) \dotfill p. \pageref{WeekdayInvitatory}
\par\noindent
...
\par\noindent
\textit{Deus creator omnium} (Creator of the Earth and Sky) \dotfill p. \pageref{WeekdayInvitatory}
\par\noindent
\textit{Deus tuorum militum} (Of all thy warrior Saints, O Lord) \dotfill p. \pageref{StephenEvensong}, p. \pageref{MartyrEvensong}), p. \pageref{MartyrsEvensongEaster} (Martyr Evensong in Easter)
\par\noindent
...
\par\noindent
\textit{Exsultet caelum gaudibus} (Let heav'n's exultant praises ring) \dotfill p. \pageref{JohnMattins}
\par\noindent
\textit{Exsultet caelum laudibus} (Let heav'n's exultant praises ring) \dotfill p. \pageref{ApostlesEvensong} (Apostles Evensong), p. \pageref{ApostlesMattins} (Apostles Mattins)
\par\noindent
...
\par\noindent
\textit{Fortem virili pectore} (High let us all our voices raise) \dotfill p. \pageref{MartyrNotVirginMattins}
\par\noindent
...
\par\noindent
Great God of boundless mercy hear (\textit{Summae Deus}) \dotfill p. \pageref{SaturdayInvitatory}
\par\noindent
...
\par\noindent
High let us all our voices raise (\textit{Fortem virili pectore}) \dotfill p. \pageref{MartyrNotVirginMattins}
\par\noindent
...
\par\noindent
Image Eterne of God Most High (\textit{Aeterna Imago Altissime}) \dotfill p. \pageref{ChristTheKingInvitatory}
\par\noindent
...
\par\noindent
\textit{In monte Olivis} (The Mount of Olives witnesseth) \dotfill p. \pageref{HolyRosaryInvitatory}
\par\noindent
In the bleak wid-winter \dotfill \#47
\par\noindent
In this our bright and Paschal day (\textit{Claro Paschali gaudio}) \dotfill p. \pageref{ApostlesMattinsEaster}
\par\noindent
...
\par\noindent
\textit{Iste Confessor} (This the Confessor of the Lord) \dotfill p. \pageref{ConfessorBishopEvensong}
\par\noindent
\textit{Iste Quem Laeti} (He, whom the faithful) \dotfill p. \pageref{JosephMattins}
\par\noindent
It came upon the midnight clear \dotfill \#48
\par\noindent
\textit{Jam bone pastor} (Peter, good shepherd) \dotfill p. \pageref{PeterAntiochMattins} (Chair of Peter Antioch Mattins), p. \pageref{PeterMattins} (Peter Mattins)
\par\noindent
...
\par\noindent
\textit{Jesu corona celsior} (O Jesu, Crown above the Sky) \dotfill p. \pageref{ConfessorNotBishopMattins}
\par\noindent
\textit{Jesu corona Virginum} (Jesu! the Virgins' Crown) \dotfill p. \pageref{VirginMartyrMattins}
\par\noindent
...
\par\noindent
\textit{Jesu Redemptor omnium} (Jesu, the world's Redeemer, hear) \dotfill p. \pageref{ConfessorBishopMattins}
\par\noindent
...
\par\noindent
Jesu! the Virgins' Crown (\textit{Jesu corona Virginum}) \dotfill p. \pageref{VirginMartyrMattins}
\par\noindent
Jesu, the world's Redeemer, hear (\textit{Jesu Redemptor omnium}) \dotfill p. \pageref{ConfessorBishopMattins}
\par\noindent
Jesu who cam'st the world to save (\textit{Jesu, Salvator saeculi}) \dotfill p. \pageref{AllHallowsMattins}
\par\noindent
Joseph, the praise and glory (\textit{Caelitum, Joseph, decus}) \dotfill p. \pageref{JosephInvitatory} (Joseph Invitatory)
\par\noindent
Joseph, the praise and glory of the heavens (\textit{Caelitum Joseph}) \dotfill p. \pageref{PatronageMattins} (Patronage Mattins)
\par\noindent
...
\par\noindent
Let heav'n's exultant praises ring (\textit{Exsultet caelum gaudibus}) \dotfill p. \pageref{JohnMattins}
\par\noindent
Let heav'n's exultant praises ring (\textit{Exsultet caelum laudibus}) \dotfill p. \pageref{ApostlesEvensong} (Apostles Evensong), \pageref{ApostlesMattins} (Apostles Mattins)
\par\noindent
Let the Holy Spirit's Grace \dotfill \#77
\par\noindent
Lift high the cross \dotfill \#20
\par\noindent
Light of Light, O Dayspring bright (\textit{Consors paterni}) \dotfill p. \pageref{TuesdayInvitatory}
\par\noindent
...
\par\noindent
\textit{Martyr Dei} (Thou followest, Martyr of thy God) \dotfill p. \pageref{StephenMattins} (Stephen Mattins), p. \pageref{MartyrMattins} (Martyr Mattins)
\par\noindent
\textit{Martyr Dei unicum} (Thou foll'west, Martyr of thy God) \dotfill p. \pageref{MartyrMattinsEaster}
\par\noindent
...
\par\noindent
\textit{Nox atra rerum} (The dusky veil of night hath laid) \dotfill p. \pageref{ThursdayInvitatory}
\par\noindent
...
\par\noindent
\textit{O gloriosa Domina} (O glorious Lady, throned in rest) \dotfill p. \pageref{BVMMattins}
\par\noindent
O glorious Lady, throned in rest (\textit{O gloriosa Domina}) \dotfill p. \pageref{BVMMattins}
\par\noindent
O God by whose command is swayed (\textit{Summae Deus clementiae}) \dotfill p. \pageref{TrinityInvitatory}
\par\noindent
...
\par\noindent
O Jesu, Crown above the Sky (\textit{Jesu corona celsior}) \dotfill p. \pageref{ConfessorNotBishopMattins}
\par\noindent
...
\par\noindent
Of all thy warrior Saints, O Lord (\textit{Deus tuorum militum}) \dotfill p. \pageref{StephenEvensong} (Stephen Evensong), p. \pageref{MartyrEvensong}) (Martyr Evensong), p. \pageref{MartyrsEvensongEaster} (Martyr Evensong in Easter)
\par\noindent
...
\par\noindent
Our limbs refreshed with slumber now (\textit{Somno Refectis}) \dotfill p. \pageref{MondayInvitatory}
\par\noindent
...
\par\noindent
Peter, good shepherd (\textit{Jam bone pastor}) \dotfill p. \pageref{PeterAntiochMattins} (Chair of Peter Antioch Mattins), p. \pageref{PeterMattins} (Peter Mattins)
\par\noindent
...
\par\noindent
\textit{Quem terra, pontus, aethera} (The God whom earth, and sea, and sky) \dotfill p. \pageref{BVMInvitatory}
\par\noindent
...
\par\noindent
\textit{Rerum Creator} (Who madest all and dost control) \dotfill p. \pageref{WednesdayInvitatory}
\par\noindent
\textit{Rex gloriose Martyrum} (All glorious King of Martyrs thou) \dotfill p. \pageref{MartyrsEvensongEaster} (Martyrs Evensong in Easter), p. \pageref{MartyrsMattins} (Martyrs Mattins)
\par\noindent
...
\par\noindent
\textit{Sanctorum meritis} (The merits of the Saints) \dotfill p. \pageref{MartyrsEvensong}
\par\noindent
...
\par\noindent
\textit{Somno Refectis} (Our limbs refreshed with slumber now) \dotfill p. \pageref{MondayInvitatory}
\par\noindent
Son of a Virgin (\textit{Virginis Proles}) \dotfill p. \pageref{VirginMartyrInvitatory}
\par\noindent
...
\par\noindent
Star of ocean fairest (\textit{Ave maris stella}) \dotfill p. \pageref{BVMEvensong}
\par\noindent
\textit{Succedit nocti lucifer} (The morning star succeeds to night) \dotfill p. \pageref{AnneMattins}
\par\noindent
\textit{Summae Deus} (Great God of boundless mercy hear) \dotfill p. \pageref{SaturdayInvitatory}
\par\noindent
\textit{Summae Deus clementiae} (O God, in whom all grace) \dotfill p. \pageref{SevenSorrowsMattins} (Seven Sorrows Mattins)
\par\noindent
\textit{Summae Deus clementiae} (O God by whose command is swayed) \dotfill p. \pageref{TrinityInvitatory} (Trinity Sunday Invitatory)
\par\noindent
...
\par\noindent
Th' Apostles' hearts were full of pain (\textit{Tristis erant Apostoli}) \dotfill p. \pageref{ApostlesEvensongEaster}
\par\noindent
That men a godly life might live \dotfill \#29
\par\noindent
The Church's one foundation \dotfill \#30
\par\noindent
The dusky veil of night hath laid (\textit{Nox atra rerum}) \dotfill p. \pageref{ThursdayInvitatory}
\par\noindent
The eternal gifts of Christ the King (\textit{Aeterna Christi munera}) \dotfill p. \pageref{ApostlesInvitatory}
\par\noindent
The fast, as taught by holy lore (\textit{Ex more docti}) \dotfill p. \pageref{FirstLentInvitatory}
\par\noindent
The first Noel \dotfill \#53
\par\noindent
The God whom earth, and sea, and sky (\textit{Quem terra, pontus, aethera}) \dotfill p. \pageref{BVMInvitatory}
\par\noindent
...
\par\noindent
The Martyrs' triumphs let us sing (\textit{Aeterna Christi munera et Martyrum}) \dotfill p. \pageref{MartyrsInvitatory}
\par\noindent
The merits of the Saints (\textit{Sanctorum meritis}) \dotfill p. \pageref{MartyrsEvensong}
\par\noindent
...
\par\noindent
The Mount of Olives witnesseth (\textit{In monte Olivis}) \dotfill p. \pageref{HolyRosaryInvitatory}
\par\noindent
...
\par\noindent
The world's Redeemer from the earth (\textit{Caelo Redemptor Praetulit}) \dotfill p. \pageref{MotherhoodInvitatory}
\par\noindent
...
\par\noindent
This the Confessor of the Lord (\textit{Iste Confessor}) \dotfill p. \pageref{ConfessorBishopEvensong}
\par\noindent
...
\par\noindent
Thou foll'west, Martyr of thy God (\textit{Martyr Dei unicum}) \dotfill p. \pageref{MartyrMattinsEaster}
\par\noindent
Thou followest, Martyr of thy God (\textit{Martyr Dei}) \dotfill p. \pageref{StephenMattins} (Stephen Mattins), p. \pageref{MartyrMattins} (Martyr Mattins)
\par\noindent
...
\par\noindent
Three in One and One in Three (\textit{Tu Trinitatis}) \dotfill p. \pageref{FridayInvitatory} (Friday Invitatory)
\par\noindent
...
\par\noindent
\textit{Tristis erant Apostoli} (Th' Apostles' hearts were full of pain) \dotfill p. \pageref{ApostlesEvensongEaster}
\par\noindent
\textit{Tu Trinitatis} (Three in One and One in Three) \dotfill p. \pageref{FridayInvitatory} (Friday Invitatory)
\par\noindent
\textit{Tu, Trinitatis Unitas} (Thou Trinity in Unity) \dotfill p. \pageref{TrinityMattins}
\par\noindent
\textit{Urbs Jerusalem beata} (Blessed City, Heav'nly Salem) \dotfill p. \pageref{DedicationEvensong}
\par\noindent
...
\par\noindent
\textit{Virginis Proles} (Son of a Virgin) \dotfill p. \pageref{VirginMartyrInvitatory}
\par\noindent
...
\par\noindent
Who madest all and dost control (\textit{Rerum Creator}) \dotfill p. \pageref{WednesdayInvitatory}
\par\noindent
With glad and joyous strains (\textit{Festivis Resonent}) \dotfill p. \pageref{PreciousBloodEvensong}
\par\noindent
With golden splendour (\textit{Aurea luce}) \dotfill p. \pageref{PeterEvensong}
\par\noindent
