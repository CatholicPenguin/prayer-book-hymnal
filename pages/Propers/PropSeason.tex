...
\subsubsection{I Evensong}\label{FirstAdventEvensong}
...
\subsection{Advent Ferial Office}
\begin{rubric}
...
\subsection{Christmas Day}\label{ChristmasDay}
\feastday{Christmas}
%\begin{inhead}
%{First Class Double, Third Class Octave}
%\end{inhead}

\subsubsection{I Evensong}\label{ChristmasEvensong}
...
\subsection{26 December. St. Stephen}
\feastday{St. Stephen}
...
\subsubsection{Evensong}\label{StephenEvensong}
...
%MANUAL ADJUSTMENT:
\clearpage
\subsection{27 December. St. John}
\feastday{St. John}
...
\subsection{28 December. Holy Innocents}
...
\subsection{Sunday within the Nativity Octave}
...
%MANUAL ADJUSTMENT:
\clearpage
\subsection{1 January. Circumcision of Our Lord}
...
\subsection{2 January. Most Holy Name of Jesus}\label{MostHolyName}
...
\subsubsection{I Evensong}\label{HolyNameEvensong}
...
\subsection{2 January. Octave Day of St. Stephen}
\feastday{St. Stephen Octave Day}
\feastdate{2}{January}
%\begin{inhead}
%    {Simple\\
%2 January}
...
\subsection{Second Sunday after Nativity}
...
%MANUAL ADJUSTMENT:
\clearpage
\subsection{3 January. Octave Day of St. John}
\feastday{St. John Octave Day}
\feastdate{3}{January}
%\begin{inhead}
%    {Simple\\
%3 January}
...
\subsection{4 January. Octave Day of Holy Innocents}
\feastday{Innocents Octave Day}
\feastdate{4}{January}
%\begin{inhead}
%    {Simple\\
%4 January}
...
\begin{rubric}
	...
	\textsc{Note,} The \blackrubric{Gloria in excelsis}.
\end{rubric}
...
\subsection{4 January. St. Titus}\label{Titus}
\feastday{St. Titus}
\feastdate{4}{January}
%\begin{inhead}
%    {Simple\\
...
\subsection{5 January. Vigil of Epiphany}
...
\begin{rubric}
	Commemoration \blackrubric{of St. Telesphorus} (p. \pageref{TelesphorusCollect}) and \blackrubric{of St. Mary after Christmas} (p. \SPMaryChristmas).
\end{rubric}
...
\begin{rubric}
	Commemoration \blackrubric{of St. Telesphorus} (p. \pageref{TelesphorusSecret}) and \blackrubric{of St. Mary after Christmas} (p. \SPMaryChristmas).
\end{rubric}
...
\begin{rubric}
	Commemoration \blackrubric{of St. Telesphorus} (p. \pageref{TelesphorusPostcommunion}) and \blackrubric{of St. Mary after Christmas} (p. \SPMaryChristmas).
\end{rubric}

%MANUAL ADJUSTMENT:
\clearpage
\subsection{5 January. St. Telesphorus}
...
\subsection{6 January. Epiphany of Our Lord}\label{EpiphanyDay}
\feastday{Epiphany}
\feastdate{}{}
%\begin{inhead}
...
\subsubsection{I Evensong}\label{EpiphanyEvensong}
...
\subsection{Within the Octave of the Epiphany}
\feastday{Within Epiphany Octave}

\subsubsection{Day II, Semidouble}
...
\subsubsection{Day III, Semidouble}
...
\subsubsection{Day IV, Semidouble}
...
\subsubsection{Day V, Semidouble}
...
\subsubsection{Day VI, Semidouble}
...
\subsubsection{Saturday within the Octave}
...
\fancyhead[RO,LE]{\textit{Septuagesima Sunday}}
\fancyhead[RE,LO]{}
%\begin{inhead}
%    {Second Class Semidouble}
%\end{inhead}
...
\subsection{Septuagesimatide Ferial Office}

%MANUAL ADJUSTMENT:
\vspace{-0.25\baselineskip}

\fancyhead[RO,LE]{\textit{Septuagesima Ferias}}
\fancyhead[RE,LO]{}
...
\end{rubric}
\begin{rubric}
	The \blackrubric{Benedictus} Antiphons are said on Ferias as set forth in the Psalter, through Tuesday after Quinquagesima.
\end{rubric}
\begin{rubric}
...
%MANUAL ADJUSTMENT:
\clearpage
\subsection{Antiphons within Septuagesima Week}
\fancyhead[RO,LE]{\textit{Septuagesima Week}}
\fancyhead[RE,LO]{}
%\begin{multicols}{2}

\subsubsection{Septuagesima Monday, Feria}
...
\subsubsection{Septuagesima Tuesday, Feria}
...
\subsection{Antiphons within Quinquagesima Week}
\fancyhead[RO,LE]{Quinquagesima Week}
\fancyhead[RE,LO]{}
%\begin{multicols}{2}

\subsubsection{Quinquagesima Monday, Feria}
...
\subsubsection{Quinquagesima Tuesday, Feria}
...
\begin{rubric}
    \nth{2} Collect is \blackrubric{Of Saints} (p. \SPSaints) \& \nth{3} \blackrubric{Of the Living and Departed} (p. \SPLiving).
\end{rubric}
...
\begin{rubric}
    \nth{2} Secret is \blackrubric{Of Saints} (p. \SPSaints) \& \nth{3} \blackrubric{Of the Living and Departed} (p. \SPLiving).
\end{rubric}
...
\begin{rubric}
    \nth{2} Postcommunion is \blackrubric{Of Saints} (p. \SPSaints) \& \nth{3} \blackrubric{Of the Living and Departed} (p. \SPLiving).
\end{rubric}
...
\gradtr{One thing have I desired of the Lord, which I will require, even that I may dwell in the house of the Lord. ℣. To behold the fair beauty of the Lord, and to hide me in his holy temple.}{O Lord, deal not with us after our sins: nor reward us according to our wickednesses. ℣. O Lord, remember not our old sins: but have mercy upon us, and that soon, for we are come to great misery. \inrub{Here genuflect.} ℣. Help us, O God of our salvation: and for the glory of thy name, O Lord, deliver us: and be merciful unto our sins, for thy name's sake.}
...
\subsection{First Sunday of Lent}\label{LentI}
...
\subsubsection{I Evensong}\label{FirstLentEvensong}
...
\subsection{Lenten Ferial Office}
\begin{rubric}
...
\subsubsection{I Evensong}\label{PassionSundayEvensong}
...
\subsection{Passiontide Ferial Office}
\begin{rubric}
...
\subsection{Easter Day}\label{EasterDay}
...
\subsubsection{II Evensong}\label{EasterEvensong}
...
%MANUAL ADJUSTMENT:
\clearpage
\subsection{Antiphons within Easter Week}
\fancyhead[RO,LE]{Easter Week}
\fancyhead[RE,LO]{}
%\begin{multicols}{2}

\subsubsection{Easter Monday}
...
\subsubsection{Easter Wednesday}
...
\subsection{Eastertide Ferial Office}
\begin{rubric}
...
\subsection{The First Week after the Easter Octave}
...
\subsection{The Second Week after the Easter Octave}
...
\subsubsection{I Evensong}\label{PatronageEvensong}
...
\subsection{The Third Week after the Easter Octave}
...
\subsection{The Fourth Week after the Easter Octave}
...
\subsection{Ascension of Our Lord}\label{Ascension}
...
\subsection{Whitsunday}\label{Whitsunday}
\feastday{Whitsunday}
%\begin{inhead}
%    {First Class Double, First Class Octave}
%\end{inhead}

\subsubsection{I Evensong}\label{WhitsundayEvensong}
...
\subsection{The Most Holy Body of Christ}\label{CorpusChristi}
...
\subsubsection{I Evensong}\label{CorpusChristiEvensong}
...
\subsubsection{I Evensong}\label{CompassionEvensong}
...
\subsection{Sundays after Trinity}
\feastday{Trinitytide}

\begin{multicols}{2}
\subsubsection{Second Sunday after Trinity}
...
\subsubsection{Third Sunday after Trinity}
...
\subsubsection{Fourth Sunday after Trinity}
...
\subsubsection{Fifth Sunday after Trinity}
...
\subsubsection{Sixth Sunday after Trinity}
...
\subsubsection{Seventh Sunday after Trinity}
...
\subsubsection{Eighth Sunday after Trinity}
...
\subsubsection{Ninth Sunday after Trinity}
...
\subsubsection{Tenth Sunday after Trinity}
...
\subsubsection{Eleventh Sunday after Trinity}
...
\subsubsection{Twelfth Sunday after Trinity}
...
\subsubsection{Thirteenth Sunday after Trinity}
...
\subsubsection{Fourteenth Sunday after Trinity}
...
\subsubsection{Fifteenth Sunday after Trinity}
...
\subsubsection{Sixteenth Sunday after Trinity}
...
\subsubsection{Seventeenth Sunday after Trinity}
...
\subsubsection{Eighteenth Sunday after Trinity}
...
\subsubsection{Nineteenth Sunday after Trinity}
...
\subsubsection{Twentieth Sunday after Trinity}
...
\subsubsection{Twenty-First Sunday after Trinity}
...
\subsubsection{Twenty-Second Sunday after Trinity}
...
\subsubsection{Twenty-Third Sunday after Trinity}
...
\subsubsection{Twenty-Fourth Sunday after Trinity}
...
\subsubsection{Sunday Next before Advent}
