...
\noindent
	...
	\gregorioscore{resources/gabc/Extra/PaschaNostrum.gabc}
		...
		\clearpage\subsubsection{Te Deum laudamus}\fancyhead[RE,LO]{Te Deum}
...
\clearpage\section{Sequences}
	%Easter
	\subsection{Victimae paschali laudes}\fancyhead[RO,LE]{\textit{Victimae Paschali}}\fancyhead[RE,LO]{Easter Sunday}
	
		\noindent
	\gregorioscore{resources/gabc/Sequences/Victimae.gabc}

	%Whitsun
	\subsection{Veni, Sancte Spiritus}\fancyhead[RO,LE]{\textit{Veni, Sancte Spiritus}}\fancyhead[RE,LO]{Whitsunday}
	
		\noindent
	\gregorioscore{resources/gabc/Sequences/VeniSancte.gabc}
	
	%All Souls
	\subsection{Dies Irae, Dies Illa}\fancyhead[RO,LE]{\textit{Dies Irae, Dies Illa}}\fancyhead[RE,LO]{Requiem}
...
\section{Paraliturgical Hymns}\fancyhead[RE,LO]{}
	...
	\clearpage\subsection{Tantum Ergo Sacramentum}\fancyhead[RO,LE]{\textit{Tantum Ergo}}
	...
	\subsection{Adoro Te Devote}\fancyhead[RO,LE]{\textit{Adoro Te Devote}}
	...
	\clearpage\subsection{Great Litany}\fancyhead[RO,LE]{\textit{Great Litany}}\label{GreatLitany}
